...
public class FileUtils {
    ...
    public static String uploadFile(MultipartFile file, String uploadPath) throws IOException {
        ...
        //중복이 없는 파일명으로 변경
        //ex) dog.jpg => 39fkgk5kf4sa-inbn4knuj235-3rf98g8k_dog.jpg
    ...
    public static String getNewUploadPath(String uploadPath) {
        ...
        //폴더 생성
        //File.separator : 운영체제에 맞게 디렉토리 경로를 만들어줌 (윈도우: \\, 맥, 리눅스: /)
    ...
    public static String getFileExtension(String fileName) {
        //ex) dalldajg-35kjklf5-53467kk-dalgjrijcfk_cat.jpg
        return fileName.substring(fileName.lastIndexOf(".") + 1); // . 다음글자부터 끝까지
    }
}
